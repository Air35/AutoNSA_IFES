...
public class CtrlDao {
    ...
    private static void criarTabelas( Statement sttmBase) throws SQLException {
        ...
        sttmBase.executeUpdate("CREATE TABLE tb_sensor(\n" +
                                ...
                                "nome TEXT(50),\n" +
                                "txt_arquivo_carga TEXT(256),\n" +
                                "unidade_medida TEXT(128));");
...
//                                "PRAGMA temp_store = MEMORY;");
    ...
    public List<AnaliseMensal> getListaAnaliseMensalEstudoSensor(String idEstudo,String idSensor){
        List<AnaliseMensal> lista;
        this.conectarBanco();
        lista = this.analiseMansalDao.getAnalisemensalEstudoSensor(conexao, idEstudo, idSensor);
        this.desconectarBanco();
        return lista;
    }
    
    public List<ListaClassificacao> getListaClassificacao(Info estudo){
        ArrayList<ListaClassificacao> lista;
        this.conectarBanco();
        lista = (ArrayList<ListaClassificacao>) this.listClassiDao.getListaClassificacao(conexao, estudo);
        this.desconectarBanco();
        return lista;        
    }
