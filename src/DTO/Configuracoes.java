...
//        this.verificarDiretorio(this.getCaminhoBasesEstudos());
    ...
    private void inicializaAmbiente(){
        if (this.IS_WINDOWS) {
            ...
            this.caminhoSistema = new String("C:\\AutoNSA");
            this.caminhoBaseEstacoes = new String("C:\\AutoNSA\\Estacoes.db");
        } else if (this.IS_LINUX){
            String raiz = System.getenv("HOME");
            System.out.println(raiz);
            this.caminhoSistema = new String(raiz + "/AutoNSA");
            this.caminhoBaseEstacoes = new String(raiz + "/AutoNSA/Estacoes.db");          
        } 
    }
