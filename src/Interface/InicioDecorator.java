...
class InicioDecorator {
    ...
    public InicioDecorator(CtrlInterface ctrlInterface) {
...
//    }
    ...
    private void configureBtn() {
        ...
        this.btMetBD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btMetBDActionPerformed(evt);
            }
        });
    ...
    public void atualizarBotoes(){
        if (this.ctrlInterface.listarEstacoes().size() == 0){
            this.btBD.setEnabled(false);
            
        } else {
            this.btBD.setEnabled(true);
        }
        if (this.ctrlInterface.listarEstudos() == null){
            this.btMetBD.setEnabled(false);
        } else{
            this.btMetBD.setEnabled(true);
        }
    }
    
    public void btMetBDActionPerformed(java.awt.event.ActionEvent evt){
        this.ctrlInterface.habilitarAbaRecuperarProcessados();
        this.ctrlInterface.recarregarRecuperarProcessadosDecorator();
        this.ctrlInterface.abrirAbaRecuperarProcessados();
        this.ctrlInterface.desabilitarAbaInicio();
        
    }
    
    public void btBDActionPerformed(java.awt.event.ActionEvent evt){
        this.ctrlInterface.habilitarAbaRecuperar();
        this.ctrlInterface.recarregarRecuperarDecorator();
        this.ctrlInterface.abrirAbaRecuperar();
        this.ctrlInterface.desabilitarAbaInicio();
    }
    
    public void btCSVActionPerformed(java.awt.event.ActionEvent evt){
        this.ctrlInterface.habilitarAbaImportar();
        this.ctrlInterface.abrirAbaImportar();
        this.ctrlInterface.desabilitarAbaInicio();
    }
//    private void panelBtn() {
//        this.configureBtn();
