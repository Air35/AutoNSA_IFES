...
//        this.jTextFieldDataFinal.setText(DataFinal);
    ...
    private void btAvancarActionPerformed(ActionEvent evt) {
        ...
        this.ctrlInterface.desabilitarAbaImportar();
...
//        this.habilitarPainel(2, false);
    ...
    private void btVoltarActionPerformed(ActionEvent evt){
        this.ctrlInterface.habilitarAbaInicio();
        this.ctrlInterface.atualizarAbaInicio();
        this.ctrlInterface.abrirAbaInicio();
        this.ctrlInterface.desabilitarAbaImportar();
    }
...
//    }
    ...
    private void btImportarActionPerformed(java.awt.event.ActionEvent evt) throws ParseException, IOException {    
        JOptionPane.showMessageDialog(null, "iniciando leitura do arquivo!\nPor favor aguarde ate a conclusão!");
        
        this.ctrlInterface.setWaitingCursor();
...
//            System.out.println(modelo.getLista());
       ...
       this.btAvancar.setEnabled(true);
    }
    ...
    public void desabilitarBtAvancar(){
        this.btAvancar.setEnabled(false);
    }
    
    public void setMouseWaiting(){
