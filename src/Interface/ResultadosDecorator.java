...
class ResultadosDecorator {
    ...
    private void btSairActionPerformed(ActionEvent evt) {
        ...
        if(this.jCheckBoxOpcao3.isSelected() && (!path.equalsIgnoreCase(""))){
            ...
            this.ctrlInterface.desabilitarAbaResultados();
    }    
    ...
    public void habilitaChkBoxBanco(){
       this.jCheckBoxOpcao1.setEnabled(true);
    }
    
    public void desabilitaChkBoxBanco(){
        this.jCheckBoxOpcao1.setEnabled(false);
    }
}
