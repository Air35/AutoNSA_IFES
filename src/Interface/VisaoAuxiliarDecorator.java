...
public class VisaoAuxiliarDecorator {
    ...
    private boolean estudoRecuperado;
    ...
    public boolean isEstudoRecuperado() {
        return estudoRecuperado;
    }

    public void setEstudoRecuperado(boolean estudoRecuperado) {
        this.estudoRecuperado = estudoRecuperado;
    }
    ...
    public boolean isFromRecuperar() {
        return fromRecuperar;
    }

    public void setFromRecuperar(boolean fromRecuperar) {
        this.fromRecuperar = fromRecuperar;
    }
    ...
    private void configureBtns(){
        ...
        this.avancarBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                setAvancarBActionPerformed(evt);                
...
//        System.out.println("Numero de colunas:" + this.ctrlInterface.getColuna().size());
        ...
        this.ctrlInterface.atualizarRelatorioResultdos();
...
//        System.out.println("Numero de colunas:" + this.ctrlInterface.getColuna().size());
    ...
    private void setAvancarBActionPerformed(ActionEvent evt){
        this.ctrlInterface.habilitarAbaResultados();
        this.ctrlInterface.atualizarRelatorioResultdos();
        if (this.isFromRecuperar()){
            this.ctrlInterface.desabiliaChkBoxBancoResultados();
        } else {
            this.ctrlInterface.habiliaChkBoxBancoResultados();
        }
        this.ctrlInterface.abrirAbaResultados();
        this.ctrlInterface.desabilitarAbaVisaoAuxiliar();
    }
