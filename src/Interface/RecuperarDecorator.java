...
//        this.jTextFieldDataFinal.setText(DataFinal);
    ...
    public void btnAvancarActionPerformed(java.awt.event.ActionEvent evt){
        ...
        this.ctrlInterface.habilitarAbaVisaoGeral();
        this.ctrlInterface.abrirAbaVisaoGeral();        
        this.ctrlInterface.desabilitarAbaRecuperar();
...
//       janela.show();
    ...
    public void btnVoltarActionPerformed(java.awt.event.ActionEvent evt){
